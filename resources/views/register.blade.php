                        ...
                        <div class="card-body p-5 shadow-5 text-center">
                            ...
                            <form>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            <input id="input" type="text" id="form3Example1" class="form-control" />
                                            <label class="form-label" for="form3Example1">Masukan Nik :</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            <input id="input" type="text" id="form3Example2" class="form-control" />
                                ...
                                <div class="form-outline mb-4">
                                    <input id="input" type="password" id="form3Example4" class="form-control" />
